...
| [`localized-appstore-screenshots`](./skills/localized-appstore-screenshots) | End-to-end pipeline for localized App Store screenshots: capture screens across locales with native Xcode tooling, extract them, and compose finished marketing shots in Figma. Each stage works independently, so it triggers on any part of the chain — per-locale captures, XCUITest/Swift Testing screenshots, or dropping shots into Figma device frames. |
...
| [`tldr`](./skills/tldr) | Summarises long plans, documents, and more into digestible sentences and key points |
